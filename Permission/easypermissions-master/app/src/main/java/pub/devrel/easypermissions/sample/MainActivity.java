...
//        } else {
//            EasyPermissions.request(this, getString(R.string.rationale_camera), RC_CAMERA_PERM, Manifest.permission.CAMERA);
//        }
//    }
//
...
//        } else {
//            EasyPermissions.request(this, getString(R.string.rationale_location_contacts), RC_LOCATION_CONTACTS_PERM, LOCATION_AND_CONTACTS);
//        }
//    }
//
//    @Override
//    public void onResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
//        super.onResult(requestCode, permissions, grantResults);
//
...
//                    EasyPermissions.hasPermissions(this, LOCATION_AND_CONTACTS) ? yes : no,
//                    EasyPermissions.hasPermissions(this, Manifest.permission.READ_SMS) ? yes : no),
//                    Toast.LENGTH_LONG)
//                    .show();
//        }
//    }
